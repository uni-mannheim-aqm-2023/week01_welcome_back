...
-   **Phase 2** (\~30 minutes): Now it's your turn! In this phase you will work on exercises that are similar to the stuff discussed in phase 1. This is all about you trying things out, doing mistakes, trying again, and succeed. Within this phase you will work together with your neighbours. You can talk to them if you have any problems or, if things are easy for you, to explain the stuff you learned to others. We will be around as well and try to solve problems and difficulties that come up. Please do not hesitate at all to make use of that.
...
The course has its own page on GitHub, you can find it here: <https://github.com/uni-mannheim-aqm-2023>. This is the place where you can find all relevant materials for the lab sessions. It is also the place where you download and hand-in your homework assignments.
...
3.  **Come to our office hours**. We both have 90 minutes reserved for AQM questions, Oliver on [Tuesdays 15:30 to 17:00](https://calendly.com/orittman/aqm), Dom on [Tuesdays 15:30 to 17:00](https://calendly.com/undzenas-qm/dom-s-aqm-office-hours). You can come to either one of us, regardless of which lab you attended that week. To avoid waiting, please schedule an appointment via Calendly 6 hours in advance. If you already have specific questions you want to ask, include them already so that we can plan and prepare for your questions ahead of time. If Tuesday does not work for you at all, slack us and we can make an appointment.
...
A lab session without an `R` exercise would be boring. So here is your first AQM `R` exercise in 2023.
